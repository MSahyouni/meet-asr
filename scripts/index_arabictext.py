...
MODELS_DIR = DATA_DIR / "models"            # Local models cache

# ===== إعدادات النماذج/الأحجام =====
_e5_local = MODELS_DIR / "multilingual-e5-base"
EMB_MODEL     = os.getenv("RAG_EMB_MODEL", _e5_local.as_posix() if _e5_local.exists() else "intfloat/multilingual-e5-base")  # بديل أسرع: paraphrase-multilingual-MiniLM-L12-v2
